...
<div class="flex flex-col m-10 max-w-full flex-wrap md:m-28 md:flex-row">
    ...
    <div class="basis-1/2 flex flex-col md:flex-row flex-wrap w-full">
        ...
        <div class="flex md:flex-row flex-col items-center md:justify-around md:ml-5 md:mr-5 m-0 mt-10 w-full">
            ...
            <button type="button" class="h-8 w-32 md:h-12 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg md:text-sm text-xs px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
