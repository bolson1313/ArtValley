...
<div class="p-4 sm:ml-64 flex justify-center center">
    <div class="md:w-1/2">
        ...
        <form class="space-y-6" action="{{ route('admin.artistCreate') }}" method="POST">
            ...
            <button type="submit" class="w-full text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create new artist</button>
        </form>
    </div>
</div>
