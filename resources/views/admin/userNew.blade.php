        ...
        <form class="space-y-6" action="{{ route('admin.usersCreate') }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" name="name" id="name"
                       ...
                       placeholder="John" value="{{ old('name') }}" required autocomplete="name" autofocus/>
                ...
                <div class="flex flex-row mb-5 mt-5">
                    <a class="basis-1/2">
                        <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                            <input id="bordered-radio-1" type="radio" value="admin" name="role"
                    ...
                    <a class="basis-1/2">
                        <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                            <input checked id="bordered-radio-2" type="radio" value="user" name="role"
                                   class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
