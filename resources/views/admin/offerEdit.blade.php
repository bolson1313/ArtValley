...
@include('shared.head', ['title' => 'Edit Offer'])
...
<div class="p-4 sm:ml-64 flex justify-center center">
    <div class="md:w-1/2">
        ...
        <form class="space-y-6" action="{{ route('admin.offerUpdate') }}" method="POST">
            @csrf
            @method('POST')
            <input class="hidden" value="{{ $offer->id }}" name="id">
            <h5 class="text-xl font-medium text-center text-gray-900 dark:text-white">Edit Offer</h5>
            <div class="m-7 basis-1/3">
                <div class="mb-5">
                    ...
                    <select id="artwork_id" name="artwork_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected value="{{ $offer->artwork_id }}">{{ $offer->artwork_id }}</option>
                ...
                <div class="mb-5">
                    ...
                    <select id="user_id" name="user_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected value="{{ $offer->user_id }}">{{ $offer->user_id }}</option>
                ...
                <div class="mb-5">
                    ...
                    <input value="{{ $offer->price }}" min="0" required type="number" name="price" id="price" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-200 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                </div>
                <div class="mb-5">
                ...
                <div class="flex flex-row mb-5">
                    <a class="basis-1/3">
                        <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                            <input @if($offer->status=='active') checked @endif id="bordered-radio-1" type="radio" value="active" name="status" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="bordered-radio-1" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Active</label>
                        </div>
                    </a>
                    <a class="basis-1/3">
                        <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                            <input @if($offer->status=='inactive') checked @endif id="bordered-radio-2" type="radio" value="inactive" name="status" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="bordered-radio-2" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Inactive</label>
                        </div>
                    </a>
                    <a class="basis-1/3">
                        <div class="flex items-center ps-4 border border-gray-200 rounded dark:border-gray-700">
                            <input @if($offer->status=='closed') checked @endif id="bordered-radio-3" type="radio" value="closed" name="status" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
